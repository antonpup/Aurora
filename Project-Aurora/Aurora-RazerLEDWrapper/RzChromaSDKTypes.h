...
//I had to add this line even though it was removed with the razer sdk update
//it really hates if it i remove it. I didnt make any other changes to this file. diogotr7
#include <windows.h>
