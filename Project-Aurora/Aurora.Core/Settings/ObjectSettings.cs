...
{
    public class ObjectSettings<T> : NotifyPropertyChangedEx where T : SettingsBase
    {
        ...
        {
            this.SettingsSavePath = Path.Combine(Const.AppDataDirectory, prefix + this.GetType().Name + ".json");
        }
