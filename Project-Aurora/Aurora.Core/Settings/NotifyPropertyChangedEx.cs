...
namespace Aurora.Core.Settings
{
    ...
    public abstract class NotifyPropertyChangedEx : INotifyPropertyChanged
    {
        ...
        public void UpdateVar<T>(ref T var, T newValue, [CallerMemberName] string propertyName = null)
        {
        ...
        public void InvokePropertyChanged(object oldValue, object newValue, [CallerMemberName] string propertyName = null)
        {
