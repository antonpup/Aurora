...
namespace Aurora.Settings.Overrides.Logic.Builder {
    ...
    public class OverrideLogicBuilder {
        ...
        public OverrideLogicBuilder SetDynamicBoolean(string layerPropertyName, IEvaluatable<bool> evaluatable) => SetDynamic(typeof(bool), layerPropertyName, evaluatable);
        ...
        public OverrideLogicBuilder SetDynamicInt(string layerPropertyName, IEvaluatable<double> evaluatable) => SetDynamic(typeof(int), layerPropertyName, evaluatable);
        ...
        /// <param name="evaluatable">The evaluatable number that will be used for this property.</param>
        public OverrideLogicBuilder SetDynamicLong(string layerPropertyName, IEvaluatable<double> evaluatable) => SetDynamic(typeof(long), layerPropertyName, evaluatable);
        ...
        /// <param name="evaluatable">The evaluatable number that will be used for this property.</param>
        public OverrideLogicBuilder SetDynamicFloat(string layerPropertyName, IEvaluatable<double> evaluatable) => SetDynamic(typeof(float), layerPropertyName, evaluatable);
        ...
        /// <param name="evaluatable">The evaluatable number that will be used for this property.</param>
        public OverrideLogicBuilder SetDynamicDouble(string layerPropertyName, IEvaluatable<double> evaluatable) => SetDynamic(typeof(double), layerPropertyName, evaluatable);
    ...
    public class OverrideLookupTableBuilder<T> {
        ...
        public OverrideLookupTableBuilder<T> AddEntry(T value, IEvaluatable<bool> when) {
