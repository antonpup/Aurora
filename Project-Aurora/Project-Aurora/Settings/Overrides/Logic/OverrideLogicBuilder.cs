...
namespace Aurora.Settings.Overrides.Logic.Builder {
    ...
    public class OverrideLogicBuilder {
        ...
        public OverrideLogicBuilder SetDynamicBoolean(string layerPropertyName, IEvaluatableBoolean evaluatable) => SetDynamic(typeof(bool), layerPropertyName, evaluatable);
        ...
        public OverrideLogicBuilder SetDynamicInt(string layerPropertyName, IEvaluatableNumber evaluatable) => SetDynamic(typeof(int), layerPropertyName, evaluatable);
        ...
        /// <param name="evaluatable">The evaluatable number that will be used for this property.</param>
        public OverrideLogicBuilder SetDynamicLong(string layerPropertyName, IEvaluatableNumber evaluatable) => SetDynamic(typeof(long), layerPropertyName, evaluatable);
        ...
        /// <param name="evaluatable">The evaluatable number that will be used for this property.</param>
        public OverrideLogicBuilder SetDynamicFloat(string layerPropertyName, IEvaluatableNumber evaluatable) => SetDynamic(typeof(float), layerPropertyName, evaluatable);
        ...
        /// <param name="evaluatable">The evaluatable number that will be used for this property.</param>
        public OverrideLogicBuilder SetDynamicDouble(string layerPropertyName, IEvaluatableNumber evaluatable) => SetDynamic(typeof(double), layerPropertyName, evaluatable);
        ...
        public OverrideLogicBuilder SetDynamicColor(string layerPropertyName, IEvaluatableNumber a, IEvaluatable r, IEvaluatable g, IEvaluatable b) {
        ...
        /// <param name="g">The evaluatable number that will be used as the green property for this color.</param>
        /// <param name="b">The evaluatable number that will be used as the blue property for this color.</param>
        public OverrideLogicBuilder SetDynamicColor(string layerPropertyName, IEvaluatable r, IEvaluatable g, IEvaluatable b) => SetDynamicColor(layerPropertyName, new NumberConstant { Value = 1 }, r, g, b);
        #endregion
    ...
    public class OverrideLookupTableBuilder<T> {
        ...
        public OverrideLookupTableBuilder<T> AddEntry(T value, IEvaluatableBoolean when) {
