...
namespace Aurora.Settings.Overrides.Logic {
    ...
    /// </summary>
    public partial class Control_NumericBinaryOpHolder : UserControl {
        /// <summary>
        /// Creates a new numeric binary operation holder control.
        /// </summary>
        public Control_NumericBinaryOpHolder(Profiles.Application application) {
            InitializeComponent();
        ...
        /// </summary>
        public Control_NumericBinaryOpHolder(Profiles.Application application, Type enumType) : this(application) {
        ...
        public IEvaluatableNumber Operand1 {
            get => (IEvaluatableNumber)GetValue(Operand1Property);
            set => SetValue(Operand1Property, value);
        }

        public static readonly DependencyProperty Operand2Property = DependencyProperty.Register("Operand2", typeof(IEvaluatableNumber), typeof(Control_NumericBinaryOpHolder), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.AffectsRender));
        public IEvaluatableNumber Operand2 {
            get => (IEvaluatableNumber)GetValue(Operand2Property);
            set => SetValue(Operand2Property, value);
        }

        public static readonly DependencyProperty SelectedOperatorProperty = DependencyProperty.Register("SelectedOperator", typeof(object), typeof(Control_NumericBinaryOpHolder), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.AffectsRender));
