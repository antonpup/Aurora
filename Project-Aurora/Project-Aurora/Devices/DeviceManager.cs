...
namespace Aurora.Devices
{
    ...
    public class DeviceManager : IDisposable
    {
        ...
        {
            devices.Add(new DeviceContainer(new Devices.Logitech.LogitechDevice()));         // Logitech
            devices.Add(new DeviceContainer(new Devices.Corsair.CorsairDevice()));           // Corsair
            devices.Add(new DeviceContainer(new Devices.Razer.RazerDevice()));               // Razer
            devices.Add(new DeviceContainer(new Devices.Roccat.RoccatDevice()));             // Roccat
            devices.Add(new DeviceContainer(new Devices.Clevo.ClevoDevice()));               // Clevo
            devices.Add(new DeviceContainer(new Devices.CoolerMaster.CoolerMasterDevice())); // CoolerMaster
            devices.Add(new DeviceContainer(new Devices.AtmoOrbDevice.AtmoOrbDevice()));     // AtmoOrb Ambilight
            devices.Add(new DeviceContainer(new Devices.SteelSeries.SteelSeriesDevice()));   // SteelSeries
            devices.Add(new DeviceContainer(new Devices.UnifiedHID.UnifiedHIDDevice()));     // UnifiedHID
            devices.Add(new DeviceContainer(new Devices.Wooting.WootingDevice()));           // Wooting
            devices.Add(new DeviceContainer(new Devices.Creative.SoundBlasterXDevice()));    // SoundBlasterX
            devices.Add(new DeviceContainer(new Devices.LightFX.LightFxDevice()));           // Alienware
            devices.Add(new DeviceContainer(new Devices.Dualshock.DualshockDevice()));       // DualShock 4
            devices.Add(new DeviceContainer(new Devices.Drevo.DrevoDevice()));               // Drevo
            devices.Add(new DeviceContainer(new Devices.YeeLight.YeeLightDevice()));         // YeeLight
            devices.Add(new DeviceContainer(new Devices.Asus.AsusDevice()));                 // Asus
            devices.Add(new DeviceContainer(new Devices.NZXT.NZXTDevice()));                 // NZXT
            devices.Add(new DeviceContainer(new Devices.Hue.HueDevice()));                   // Philips Hue
