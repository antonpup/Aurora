    ...
    (lambda (data)
        ...
        (when (mousepad:? data)
            (let* ((mousepad (mousepad: data))
                ...
                (on-device ""rgb-12-zone"" show-on-zone: mpone one:)
                (on-device ""rgb-12-zone"" show-on-zone: mptwo two:)
                (on-device ""rgb-12-zone"" show-on-zone: mpthree three:)
                (on-device ""rgb-12-zone"" show-on-zone: mpfour four:)
                (on-device ""rgb-12-zone"" show-on-zone: mpfive five:)
                (on-device ""rgb-12-zone"" show-on-zone: mpsix six:)
                (on-device ""rgb-12-zone"" show-on-zone: mpseven seven:)
                (on-device ""rgb-12-zone"" show-on-zone: mpeight eight:)
                (on-device ""rgb-12-zone"" show-on-zone: mpnine nine:)
