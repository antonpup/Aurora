...
namespace Aurora.Devices.Razer
{
    public static class RazerLayoutMap
    {
        ...
        public static readonly Dictionary<DeviceKeys, int[]> Blade = new Dictionary<DeviceKeys, int[]>
        {
            ...
            {DeviceKeys.F5, new int [] {0, 5} },
            {DeviceKeys.F6, new int [] {0, 6} },
            {DeviceKeys.F7, new int [] {0, 7} },
            {DeviceKeys.F8, new int [] {0, 8} },
            {DeviceKeys.F9, new int [] {0, 9} },
            {DeviceKeys.F10, new int [] {0, 10} },
            {DeviceKeys.F11, new int [] {0, 11} },
            {DeviceKeys.F12, new int [] {0, 12} },
            {DeviceKeys.INSERT, new int [] {0, 13} },
            {DeviceKeys.DELETE, new int [] {0, 14} },
            ...
            {DeviceKeys.LEFT_FN, new int [] {5, 1} },
            {DeviceKeys.LEFT_WINDOWS, new int [] {5, 2} },
            {DeviceKeys.LEFT_ALT, new int [] {5, 3} },
            ...
            {DeviceKeys.ARROW_RIGHT, new int [] {5, 14} }
        };
    }
}
