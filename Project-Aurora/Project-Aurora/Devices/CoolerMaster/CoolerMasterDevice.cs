...
namespace Aurora.Devices.CoolerMaster
{
    static class CoolerMasterKeys
    {
        ...
        public static readonly Dictionary<DeviceKeys, int[]> CKCoords = new Dictionary<DeviceKeys, int[]>
        {
            {DeviceKeys.ESC, new int [] {0,0} },
            {DeviceKeys.F1, new int [] {0, 1} },
            {DeviceKeys.F2, new int [] {0, 2} },
        ...
        public static readonly Dictionary<DeviceKeys, int[]> MMProLCoords = new Dictionary<DeviceKeys, int[]>
        {
            {DeviceKeys.Peripheral, new int [] {0,0} }
        };

        public static readonly Dictionary<DeviceKeys, int[]> MMProSCoords = new Dictionary<DeviceKeys, int[]>
        {
            {DeviceKeys.Peripheral_FrontLight, new int [] {0,0} },
            {DeviceKeys.Peripheral_ScrollWheel, new int [] {0,1} }
        };

        public static readonly Dictionary<DeviceKeys, int[]> MM520Coords = new Dictionary<DeviceKeys, int[]>
        {
            {DeviceKeys.Peripheral_FrontLight, new int [] {0,0} },
            {DeviceKeys.Peripheral_Logo, new int [] {0,1} },
            {DeviceKeys.Peripheral_ScrollWheel, new int [] {0,2} }
        };

        public static readonly Dictionary<DeviceKeys, int[]> MM530Coords = new Dictionary<DeviceKeys, int[]>
        {
            {DeviceKeys.Peripheral_FrontLight, new int [] {0,0} },
            {DeviceKeys.Peripheral_Logo, new int [] {0,1} },
            {DeviceKeys.Peripheral_ScrollWheel, new int [] {0,2} }
        ...
        public static readonly Dictionary<CoolerMasterSDK.DEVICE_INDEX, Dictionary<DeviceKeys, int[]>> KeyboardLayoutMapping = new Dictionary<CoolerMasterSDK.DEVICE_INDEX, Dictionary<DeviceKeys, int[]>>
        {
            ...
            { CoolerMasterSDK.DEVICE_INDEX.DEV_CK372, CKCoords },
            { CoolerMasterSDK.DEVICE_INDEX.DEV_CK550_552, CKCoords },
            { CoolerMasterSDK.DEVICE_INDEX.DEV_CK551, CKCoords },
            { CoolerMasterSDK.DEVICE_INDEX.DEV_MMouse_L, MMProLCoords },
            { CoolerMasterSDK.DEVICE_INDEX.DEV_MMouse_S, MMProSCoords },
            { CoolerMasterSDK.DEVICE_INDEX.DEV_MM520, MM520Coords },
            { CoolerMasterSDK.DEVICE_INDEX.DEV_MM530, MM530Coords }
        };
