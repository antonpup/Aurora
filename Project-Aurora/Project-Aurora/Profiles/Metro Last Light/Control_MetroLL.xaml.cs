...
namespace Aurora.Profiles.Metro_Last_Light
{
    ...
    public partial class Control_MetroLL : UserControl
    {
        ...
        private void SetSettings()
        {
            ...
            this.cz.ColorZonesList = (profile_manager.Profile as MetroLLProfile).lighting_areas;
        }
        ...
        private void cz_ColorZonesListUpdated(object sender, EventArgs e)
        {
            if (IsLoaded)
            {
                (profile_manager.Profile as MetroLLProfile).lighting_areas = (sender as ColorZones).ColorZonesList;
                profile_manager.SaveProfiles();
            }
        }
