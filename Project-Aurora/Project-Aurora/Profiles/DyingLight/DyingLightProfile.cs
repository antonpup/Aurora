            ...
            Layers = new System.Collections.ObjectModel.ObservableCollection<Layer>()
            {
                new Layer("Movement", new SolidColorLayerHandler()
                {
                    Properties = new LayerHandlerProperties()
                    {
                        ...
                        _Sequence = new KeySequence(new DeviceKey[] { Devices.DeviceKeys.W, Devices.DeviceKeys.A, Devices.DeviceKeys.S, Devices.DeviceKeys.D, Devices.DeviceKeys.SPACE, Devices.DeviceKeys.C, Devices.DeviceKeys.LEFT_SHIFT })
                    }
                }
                ),
                new Layer("Actions", new SolidColorLayerHandler()
                {
                    Properties = new LayerHandlerProperties()
                    {
                        ...
                        _Sequence = new KeySequence(new DeviceKey[] { Devices.DeviceKeys.Q, Devices.DeviceKeys.E, Devices.DeviceKeys.R, Devices.DeviceKeys.F, Devices.DeviceKeys.V, Devices.DeviceKeys.B })
                    }
                }
                ),
                new Layer("Inventory", new SolidColorLayerHandler()
                {
                    Properties = new LayerHandlerProperties()
                    {
                        ...
                        _Sequence = new KeySequence(new DeviceKey[] { Devices.DeviceKeys.I, Devices.DeviceKeys.M, Devices.DeviceKeys.L, Devices.DeviceKeys.U})
                    }
                }
                ),
                new Layer("Healing", new SolidColorLayerHandler()
                {
                    Properties = new LayerHandlerProperties()
                    {
                        ...
                        _Sequence = new KeySequence(new DeviceKey[] { Devices.DeviceKeys.H}),
                    }
                }
                ),
                new Layer("Flashlight", new SolidColorLayerHandler()
                {
                    Properties = new LayerHandlerProperties()
                    {
                        ...
                        _Sequence = new KeySequence(new DeviceKey[] { Devices.DeviceKeys.T})
                    }
                }),
