...
namespace Aurora.Profiles.XCOM
{
    ...
    public partial class Control_XCOM : UserControl
    {
        ...
        private void SetSettings()
        {
            ...
            this.cz.ColorZonesList = (profile_manager.Profile as XCOMProfile).lighting_areas;
        }
        ...
        private void cz_ColorZonesListUpdated(object sender, EventArgs e)
        {
            if (IsLoaded)
            {
                (profile_manager.Profile as XCOMProfile).lighting_areas = (sender as ColorZones).ColorZonesList;
                profile_manager.SaveProfiles();
            }
        }
