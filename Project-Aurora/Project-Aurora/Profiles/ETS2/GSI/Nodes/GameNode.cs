namespace Aurora.Profiles.ETS2.GSI.Nodes {
    public class GameNode : Node<GameNode> {
        ...
        public bool connected => _memdat.ets2_telemetry_plugin_revision != 0 && _memdat.timeAbsolute != 0;

        /// <summary>The name of the game (e.g. "ETS2").</summary>
        public string gameName;

        /// <summary>Whether the game has been paused by the player.</summary>
        public bool paused => _memdat.paused != 0;

        /// <summary>The time scale in the game.</summary>
        public float timeScale => _memdat.localScale;

        /// <summary>The game major version.</summary>
        public int versionMajor => (int)_memdat.ets2_version_major;
        /// <summary>The game minor version.</summary>
        public int versionMinor => (int)_memdat.ets2_version_minor;

        /// <summary>The telemetry server major version.</summary>
        public int telemetryPluginVersion => (int)_memdat.ets2_telemetry_plugin_revision;
        ...
        internal GameNode(ETS2MemoryStruct memdat) {
            _memdat = memdat;
        }
    }
}
