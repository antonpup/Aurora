            ...
            Layers = new System.Collections.ObjectModel.ObservableCollection<Layer>()
            {
                new Layer("Movement", new SolidColorLayerHandler()
                {
                    Properties = new LayerHandlerProperties()
                    {
                        ...
                        _Sequence = new KeySequence(new DeviceKey[] { Devices.DeviceKeys.W, Devices.DeviceKeys.A, Devices.DeviceKeys.S, Devices.DeviceKeys.D, Devices.DeviceKeys.SPACE, Devices.DeviceKeys.Q, Devices.DeviceKeys.E, Devices.DeviceKeys.V, Devices.DeviceKeys.R })
                    }
                }
                ),
                new Layer("Skills", new SolidColorLayerHandler()
                {
                    Properties = new LayerHandlerProperties()
                    {
                        ...
                        _Sequence = new KeySequence(new DeviceKey[] { Devices.DeviceKeys.TILDE, Devices.DeviceKeys.ONE, Devices.DeviceKeys.TWO, Devices.DeviceKeys.THREE, Devices.DeviceKeys.FOUR, Devices.DeviceKeys.FIVE, Devices.DeviceKeys.SIX, Devices.DeviceKeys.SEVEN, Devices.DeviceKeys.EIGHT, Devices.DeviceKeys.NINE, Devices.DeviceKeys.ZERO })
                    }
                }
                ),
                new Layer("Targeting", new SolidColorLayerHandler()
                {
                    Properties = new LayerHandlerProperties()
                    {
                        ...
                        _Sequence = new KeySequence(new DeviceKey[] { Devices.DeviceKeys.T, Devices.DeviceKeys.TAB })
                    }
                }
                ),
                ...
                new Layer("Actions", new SolidColorLayerHandler()
                {
                    Properties = new LayerHandlerProperties()
                    {
                        ...
                        _Sequence = new KeySequence(new DeviceKey[] { Devices.DeviceKeys.F, Devices.DeviceKeys.C })
                    }
                }),
