...
namespace Aurora.Settings.Layers
{
    ...
    public class InteractiveLayerHandler : LayerHandler<InteractiveLayerHandlerProperties>
    {
        ...
        public InteractiveLayerHandler()
        {
            ...
            AuroraCore.Instance.InputEvents.KeyDown += InputEventsKeyDown;
            AuroraCore.Instance.InputEvents.KeyUp += InputEventsKeyUp;
        }
        ...
        public override EffectLayer Render(IGameState gamestate)
        {
            ...
            foreach (var input in _input_list.ToArray())
            {
                ...
                {
                    AuroraCore.logger.Error("Interative layer exception, " + exc);
                }
            }
