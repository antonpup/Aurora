...
namespace Aurora.Settings.Layers
{
    ...
    public class EqualizerLayerHandler : LayerHandler<EqualizerLayerHandlerProperties>
    {
        ...
        private void CheckForDeviceChange()
        {
            ...
            {
                AuroraCore.logger.Info($"CaptureState is {((WasapiLoopbackCapture)waveIn)?.CaptureState}");
        ...
        public override EffectLayer Render(IGameState gamestate)
        {
            ...
            {
                AuroraCore.logger.Error("Error encountered in the Equalizer layer. Exception: " + exc.ToString());
