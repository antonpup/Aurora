...
namespace Aurora.Profiles
{
    ...
    public class LightingStateManager : ManagerSettings<LightingStateManagerSettings>
    {
        ...
        public string AdditionalProfilesPath = Path.Combine(Const.AppDataDirectory, "AdditionalProfiles");
        ...
        public override bool Initialize()
        {
            ...
            AuroraCore.Instance.InputEvents.KeyDown += CheckProfileKeybinds;
        ...
        public ILightEvent GetCurrentProfile(out bool preview)
        {
            ...
            else if (this.Settings.AllowWrappersInBackground && AuroraCore.Instance.net_listener != null && AuroraCore.Instance.net_listener.IsWrapperConnected && ((tempProfile = GetProfileFromProcessName(AuroraCore.Instance.net_listener.WrappedProcess)) != null) && tempProfile.Config.Type == LightEventType.Normal && tempProfile.IsEnabled)
                profile = tempProfile;
        ...
        public void CheckProfileKeybinds(object sender, SharpDX.RawInput.KeyboardInputEventArgs e)
        {
            ...
            {// && Controls.Control_Keybind._ActiveKeybind == null) {
