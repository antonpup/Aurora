...
namespace Aurora.Profiles
{
    ...
    public class LocalPCInformation : Node<LocalPCInformation>
    {
        ...
        //https://github.com/dotnet/corefx/issues/22660
        /// <summary>
        /// Used RAM
        /// </summary>
        ...
        static LocalPCInformation()
        {
            ...
            {
                AuroraCore.logger.Error("Failed to create PerformanceCounter. Try: https://stackoverflow.com/a/34615451 Exception: " + exc);
            }
            ...
            void StartStopRecording()
            {
                ...
                try
                {
                    if (AuroraCore.Instance.Settings.EnableAudioCapture)
            ...
            StartStopRecording();
            AuroraCore.Instance.Settings.PropertyChanged += (sender, e) =>
            {
        ...
        private void CpuCounterTimer_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            {
                AuroraCore.logger.Error("PerformanceCounter exception: " + exc);
            }
        }
    }
}
