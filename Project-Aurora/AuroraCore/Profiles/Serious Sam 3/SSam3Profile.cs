            ...
            Layers = new System.Collections.ObjectModel.ObservableCollection<Layer>()
            {
                ...
                new Layer("Other Actions", new SolidColorLayerHandler()
                {
                    Properties = new LayerHandlerProperties()
                    {
                        ...
                        _Sequence = new KeySequence(new List<KeyboardKeys> { KeyboardKeys.LEFT_CONTROL, KeyboardKeys.R, KeyboardKeys.Q, KeyboardKeys.E, KeyboardKeys.LEFT_SHIFT }.ConvertAll(s => s.GetDeviceLED()))
                    }
                }),
