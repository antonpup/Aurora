...
namespace Aurora.Profiles.Move_or_Die
{
    ...
    {
        public MoD()
            : base(new LightEventConfig { Name = "Move or Die", ID = "MoD", ProcessNames = new[] { "love.exe" }, ProfileType = typeof(MoDProfile), GameStateType = typeof(GameState_Wrapper), Event = new GameEvent_Generic(), IconURI = "Resources/MoD.png" })
        {
